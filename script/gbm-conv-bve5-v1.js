			...
			// ************ on curve section ************
				...
				if (i >= stIdx && i <= edIdx) {
					if (i == stIdx) {
						...
						tmpTxt += '\tRepeater[\'railbase_0\'].Begin(, 0, 0, 0, 0, 0, 0, 3, 5, 5,\'' + defaultrailbasekey + '\');\n'; //ballast@slab
						//Repeater['Ballast'].Begin(, 0, 0, 0, 0, 0, 0, 3, 5, 5, 'Ballast0', 'Ballast1', 'Ballast2', 'Ballast3', 'Ballast4');

						tmpTxt += '\tRepeater[\'railL_0\'].Begin(, 0, 0, 0, 0, 0, 0, 3, 5, 5,\'' + defaultrailLkey + '\');\n';
						//Repeater['RailL'].Begin(, -0.5335, 0, 0, 0, 0, 0, 3, 5, 5, 'RailL0', 'RailL1', 'RailL2', 'RailL3', 'RailL4');

						tmpTxt += '\tRepeater[\'railR_0\'].Begin(, 0, 0, 0, 0, 0, 0, 3, 5, 5,\'' + defaultrailRkey + '\');\n';
						//Repeater['RailR'].Begin(, 0.5335, 0, 0, 0, 0, 0, 3, 5, 5, 'RailR0', 'RailR1', 'RailR2', 'RailR3', 'RailR4');

						if (typeof defaultohwirekey != 'undefined' && defaultohwirekey!= '') {
							tmpTxt += '\tRepeater[\'ohwire_0\'].Begin(, 0, 0, 0, 0, 0, 0, 3, 25, 25,\'' + defaultohwirekey + '\');\n';
						}
			...
			if (arrK_1[1] == '0') {
				for (g = 0; g < bvetunnelObjArr.length; g++) {
					if (bvetunnelObjArr[g][1] == arrK_1[0]) {
						...
						subTrkArr.push([crX-1, '\tCabIlluminance.Interpolate(1);\n']);
						subTrkArr.push([crX, '\tCabIlluminance.Interpolate(0);\n']);
				...
				for (g = 0; g < bvetunnelObjArr.length; g++) {
					if (bvetunnelObjArr[g][1] == arrK_1[0]) {
						if (bvetunnelObjArr[g][1] == arrK_1[0]) {
							...
							subTrkArr.push([crX-1, '\tCabIlluminance.Interpolate(0);\n']);
				...
				if (sArr[1] == '0') { //side line start
					...
					if (stSwlength != 0) {
						...
						if (cIdx >= stIdx && cIdx <= edIdx) { 
							...
							if (typeof defaultohwirekey != 'undefined' && defaultohwirekey!= '') {
								subTrkArr.push([ crX, '\tRepeater[\'ohwire_' + railIdx + '\'].Begin(\'' + railIdx + '\', 0, 0, 0, 0, 0, 0, 3, 25, 25,\'' + defaultohwirekey + '\');\n']); 
							}
							if (stOffset == 0) {
