...
// *****************************Dialog Operation ******************************					
 					...
 					if (j == 0) {
 						...
 						if ((cgep >= parseInt(td0[0])) && (cgep <= parseInt(td1[0]))) {
							if (cgep == parseInt(td0[0])) {
								...
								if (document.getElementById('vcurvesEv').checked) {
									var artxt = cgep.toString() + ',,0' + '¤'+Rv+'¤'+tvc+'¤'+Lvc + ',,';
									//artxt = artxt.replace('undefined','');
									arrTE.splice(j,0,artxt);
									break;
								} else {
	...
	$('#btnSetpitchOp').click(function() {
			...
			for (var i = 0; i < arrTE.length; i++) {
				if (arrTE[i] != '') {
					...
					if (i == 0) {
						...
						if (arr0[2] != '') { MapToolbar.features["lineTab"][polyIDtxt].markers.getAt(miSt).bdata.pitch = arr0[2]; }
						if (arr0[3] != '') { 
						...
						if (arr0[2] != '') { MapToolbar.features["lineTab"][polyIDtxt].markers.getAt(endidx).bdata.pitch = arr0[2]; }
						if (arr0[3] != '') {
									...
									switch (arr2[0]) {
										...
										case 'tcurve' :
											if (arr2[1] == 'startT') {
												...
												//2do vcurve 25/4/2016
												if (arr0[2] != '') { MapToolbar.features["tcurveTab"][cuvid].markers.getAt(0).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
												...
												if (arr0[2] != '') { MapToolbar.features["tcurveTab"][cuvid].markers.getAt(1).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
												...
												if (arr0[2] != '') { MapToolbar.features["tcurveTab"][cuvid].markers.getAt(3).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
												...
												if (arr0[2] != '') { MapToolbar.features["tcurveTab"][cuvid].markers.getAt(4).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
												...
												if (arr0[2] != '') { MapToolbar.features["tcurveTab"][cuvid].markers.getAt(l).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
										...
										case 'curve' :
											if (arr2[1] == 'start') {
												...
												if (arr0[2] != '') { MapToolbar.features["curveTab"][cuvid].markers.getAt(0).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
												...
												if (arr0[2] != '') { MapToolbar.features["curveTab"][cuvid].markers.getAt(1).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
												...
												if (arr0[2] != '') { MapToolbar.features["curveTab"][cuvid].markers.getAt(l).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
								...
								if (cuvid == '') {
									...
									for (var j= miSt; j <= miEd; j++) {
										...
										if ((distancePrv <= pitchStrdistance) && (pitchStrdistance <= distanceNow)) {
											if (pitchStrdistance == distanceNow) {
												...
												if (arr0[2] != '') { MapToolbar.features["lineTab"][polyIDtxt].markers.getAt(j).bdata.pitch = arr0[2]; }
												if (arr0[3] != '') { 
									...
									if (cuvtype == 'curve') {
										...
										if ((cvStD <= pitchStrdistance) && (pitchStrdistance <= cvEdD)) {
											...
											if (arr0[2] != '') { cpoly.markers.getAt(cuvNewIdx).bdata.pitch = arr0[2]; }
											if (arr0[3] != '') { 
										...
										if ((tcTst <= pitchStrdistance) && (pitchStrdistance <= tcCst)) {
											...
											if (arr0[2] != '') { tcpoly.markers.getAt(cuvNewIdx).bdata.pitch = arr0[2]; }
											if (arr0[3] != '') { 
		...
		$('#btnUpdateMarkerSetting').click(function() {
			...
			if ( $('#dms_pitch').val() != '') { MapToolbar.features[tab][pid].markers.getAt(mIdx).bdata.pitch = $('#dms_pitch').val(); }
